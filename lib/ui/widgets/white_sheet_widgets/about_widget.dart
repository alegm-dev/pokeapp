...
import 'package:pokeapp/models/pokemon_about_data.dart';
    ...
    return SingleChildScrollView(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            TitleAndSubtitleWidget(title: 'Descripcion', subtitle: flavorText),
            TitleAndSubtitleWidget(
                title: 'Tasa de crecimiento', subtitle: growthRate.toString()),
            TitleAndSubtitleWidget(
                title: 'Habitat', subtitle: habitat.toString()),
            TitleAndSubtitleWidget(
                title: 'Tasa de captura',
                subtitle: '${captureRate.toString()} %'),
            TitleAndSubtitleWidget(
                title: 'Felicidad',
                subtitle: '${baseHappiness.toString()} point'),
            // egg groups list
            PokemonInfoListWidget(listTitle: 'Cria', pokemonData: eggGroups),
          ],
        ),
      ),
    );
