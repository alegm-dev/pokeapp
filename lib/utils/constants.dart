...
const Color scaffoldLightThemeColor = Color.fromRGBO(245, 251, 251, 1);
...
const Color backIconDarkThemeColor = Colors.white;
const Color pokemonNameTitleLightThemeColor = Color.fromRGBO(54, 48, 83, 1);
const Color pokemonNameTitleDarkThemeColor = Colors.white;
const Color pokemonTypeLightThemeColor = Color.fromRGBO(93, 95, 123, .6);
const Color favoriteIconLightColor = Colors.white;
const Color whiteSheetLightThemeColor = Colors.white;
const Color whiteSheetDarkThemeColor = Color.fromRGBO(19, 19, 19, 1);
const double detailScreenIconSize = 40;
const double whiteSheetRadius = 52;

// SearchScreen
const Color chooseFilterTextLightThemeColor = Color.fromRGBO(54, 48, 83, 1);
const Color chooseFilterTextDarkThemeColor = Colors.white;
const Color selectedDarkThemeColor = Colors.redAccent;
const Color selectedLightThemeColor = Color.fromRGBO(54, 48, 83, 1);
